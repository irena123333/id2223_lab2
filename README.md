...
Advanced feature extraction methods such as MFCC features.
Other Swedish data sources, including official or paid databases and updating the model via the data provided by users’ recording.
